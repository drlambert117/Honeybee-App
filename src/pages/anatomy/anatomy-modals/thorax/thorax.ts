...
export class ThoraxModal {
  ...
  extractData(data: any) {
    ...
    this.modal_Data = this.selectedPage[0].anatomy_modals[2];
    console.log("modal_Data: ");
    console.table(this.modal_Data);

    this.modal_Intro = this.selectedPage[0].anatomy_modals[2].modal_intro;
    console.log(this.modal_Intro);

    this.modal_Sections = this.selectedPage[0].anatomy_modals[2].modal_sections;
